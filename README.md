...
![image](https://github.com/user-attachments/assets/c88764c8-9ace-42a7-80a7-ad56f28f499a)
...
After initializing the alarm, if we hit the time set, the alarm begins to ring. To stop it, we need to push the sixth button for 1 or 2 seconds.
