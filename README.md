...
After initializing the alarm, if we hit the time set, the "[alarm](https://github.com/Alexandre-Coulibaly/Clock2/blob/main/alarm.py)" begins to ring. To stop it, we need to push the sixth button.
